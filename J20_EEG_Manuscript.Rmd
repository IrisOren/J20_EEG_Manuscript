...
```{r SelectTreatmentCondition_Chunk, echo=FALSE, include=FALSE}
...
ecdf_plot_all<-ecdf_plot_all + geom_step() + xlab("Number of spikes") + ylab("Number of intervals") + facet_wrap(~Genotype) +ggtitle("Cumulative frequency of Spike count/8s interval")
