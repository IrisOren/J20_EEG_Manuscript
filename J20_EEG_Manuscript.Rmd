...
#,EXPAND FILELIST  WHEN OTHERS REPLY ABOUT PROCESSED AVAILABLE FILES
...
```{r, PlotThetaDeltaSW_JF220, echo=FALSE, include=FALSE}
...
```{r, PlotThetaDeltaSW_J0373, echo=FALSE, include=FALSE}
ListID<-"J0373_Day"
