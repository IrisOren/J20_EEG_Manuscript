...
write.csv(Fig2SummaryDataframe_J20, "/Ouput/Fig2SummaryDataframe_J20.csv")

write.csv(Fig2SummaryDataframe, "/Ouput/Fig2SummaryDataframe.csv")
...
Fig4SummaryDataframe<-filter(Fig4SummaryDataframe, Fig3_BrainState=="YES", Genotype=="J20", LossIntervalPercentage<LossIntervalPercentageThreshold  )
...
SummaryThetaDelta<-filter(SummaryThetaDelta, AnimalIDVariable %in% Fig4SummaryDataframe$AnimalID)
SummaryThetaDelta
