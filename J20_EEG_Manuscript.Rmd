...
MeanAgeOfAnimals<-mean(SummaryDataframe$Age, na.rm=TRUE)

SEMAgeOfAnimals<-sd(SummaryDataframe$Age, na.rm = TRUE)/nrow(SummaryDataframe)

```
Mean age of animals = `r MeanAgeOfAnimals`
