...
for(FileIndex in 1:length(FileList)){
   ...
   AnimalIDCurrent<-AnimalIDList[[FileIndex]]
    ...
    #rename animalIDVideoStartEnd dataframe
    #names(AnimalIDVideoStartEnd)<-c("AnimalIDVariable", "VideoStart", "VideoEnd")
}
...
SCPP1DataframeJF220VideoTimesAll$ThetaOverDelta<-SCPP1DataframeJF220VideoTimes$Theta/SCPP1DataframeJF220VideoTimes$Delta
