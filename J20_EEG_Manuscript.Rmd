...
All animals exhibited significant phase coupling of IIS as estimated by the Rayleigh test (p=(`r min(Fig2SummaryDataframe_J20$RayleighP) -- max(Fig2SummaryDataframe_J20$RayleighP)`. The degree of phase coupling varied between animals as can be seen in the distribution of the angular dispersion, rho (round(mean Fig2SummaryDataframe$Rho, 2)` CI=t$conf.int).
...
Across the sample, the mean IIS coupling was  Phi_J20=`r SampleMeanDateTime$TimeOfDayTimeFormat`, confirming that IIS occurred preferentially during the daylight hours.