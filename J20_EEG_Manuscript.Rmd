...
Example of theta/delta and spike count
...
SleepWakeSpikeCountPlot<-ggplot(SleepWakeSpikeCountData,
  ...
  theme(legend.position = "none")
      ...
      ThetaPlot<-ggplot(SleepWakeSpikeCountData, aes(x=ZeroTime, y=Theta)) +
        geom_point() + 
        ylim(0,100) +
        xlab("Time (s)") +
  ...
  xlim(c(0, 7200))+ 
      ...
      DeltaPlot<-ggplot(SleepWakeSpikeCountData, aes(x=ZeroTime, y=Delta)) +
        geom_point()+
        ylim(0,200)+
      ...
      ThetaOverDeltaPlot<-ggplot(SleepWakeSpikeCountData, aes(x=ZeroTime, y=ThetaOverDelta)) +
        geom_point() +
        ylim(0, 5) +
    ...
    SleepWakeThetaDelta<-plot_grid(ThetaPlot, DeltaPlot, ThetaOverDeltaPlot,SleepWakeSpikeCountPlot,  align = "v", nrow = 4)
  
 SleepWakeThetaDelta
 
ggsave("Output/Figures/Fig4/Fig4A.png",device="png", dpi=300)      
