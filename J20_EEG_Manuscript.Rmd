...
NDFDataParentFolder<-"~/Dropbox/ANALYSIS/J20_EEG_Manuscript/Data/SCPP3V2_TCL"
       ...
       #Next import all files in input_path to create a new r dataframe called             `SCPP1Dataframe'
          SCPPDataframe<-ImportData(FullPath)
           ...
           # Exclude Loss and Artifact intervals which have delta power >3sd and write the number of ExcludedIntervals to ExcludedIntervalsVariable in SCPP1Dataframe
            TotalIntervals<-nrow(SCPP1Dataframe)
...
AChEAbsorption.model<-lmer(ThioclineRate~ (1|RepeatID)+GenotypeTreatment, data=AChEAbsorption, REML = FALSE)
summary(AChEAbsorption.model)


#Test signficance of fixed effect
AChEAbsorption.null<-lmer(ThioclineRate~ (1|RepeatID), data=AChEAbsorption, REML = FALSE)
