...
Hour<-hour(SCPP1DataframeAll$TimeOfDay)
SCPP1DataframeAll$LightDark <- Hour %in% seq(7, 18)

```

Add ThetaOverDelta
```{r ThetaOverDeltaChunk, echo=FALSE, include=FALSE}
SCPP1DataframeAll$ThetaOverDelta<-SCPP1DataframeAll$Theta/SCPP1DataframeAll$Delta
```

Save SCPP1DataframeAll to output directory
```{r SaveSCPP1DataframeAllChunk, echo=FALSE, include = FALSE}
