...
ThetaPlot<-ggplot(SleepWakeSpikeCountDataWT, 
        ...
        scale_colour_grey() +
        geom_point(size=PtSize) + 
        scale_y_continuous(limits=c(0,10000), breaks=seq(0, 20000, 10000))+
        xlab("Time (s)") +
  ylab(expression(paste(theta, " (", mu, V^{2}, ")"))) +
  xlim(c(0, 7200))+ 
        theme(axis.title.x=element_blank(), 
...
ThetaOverDeltaPlot<-ggplot(SleepWakeSpikeCountDataWT, 
  ...
  xlab("Time (s)")
    ...
    SleepWakeThetaDelta<-plot_grid(DeltaPlot,ThetaPlot,  ThetaOverDeltaPlot, align = "v", nrow = 3, rel_heights = c(1,1,1))
