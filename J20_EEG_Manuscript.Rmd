...
SummaryStatsGrtr0Spikes$CI_L<-SummaryStatsGrtr0Spikes$Grtr0SpikeCtrl-SummaryStats$ci
SummaryStatsGrtr0Spikes$CI_U<-SummaryStatsGrtr0Spikes$Grtr0SpikeCtrl+SummaryStats$ci
...
ggsave("Output/Figures/Fig3/Fig3A.pdf", device="pdf")
...
ggsave("Output/MeanSpikesSleepWake.pdf", device="pdf")
...
ggsave("Output/Figures/Fig4/Fig4B.pdf", device="pdf")
...
if(file.exists(ETAvFilename)==1){
  ...
  for(AnimalIndex in 1:length(AnimalIDList)){
    ...
    rm(ETAv, ETAvDataframeTemp, ETW, SCPPDataframeEventAv)
...
NoIntervalsToSample<-2000
  ...
  rm(NETAv, NETAvDataframeTemp, NETW, SCPPDataframeEventAv)
...
ggsave("Output/Figures/Fig4/Fig4C.pdf", device="pdf")
