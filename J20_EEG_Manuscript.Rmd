...
#4. Determine phase coupling of strength and compare between WT and J20.
...
All animals exhibited significant phase coupling of IIS as estimated by the Rayleigh test (p=(`r min(Fig2Summarydataframe_J20$RayleighP)` - `r max(Fig2Summarydataframe_J20$RayleighP)`. The degree of phase coupling varied between animals as can be seen in the distribution of the angular dispersion, rho (round(mean Fig2SummaryDataframe$Rho, 2)` CI=t$conf.int).



```{r DistributionOfRhoJ20, echo=FALSE, include=FALSE}
RhoHist<-ggplot(Fig2SummaryDataframe_J20, aes(x=Rho)) + 
...
Across the sample, the mean IIS coupling was `r Phi~J20~=SampleMeanDateTime$TimeOfDayTimeFormat`, confirming that IIS occurred preferentially during the daylight hours.