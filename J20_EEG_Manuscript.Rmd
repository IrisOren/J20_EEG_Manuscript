...
#Import
VideoScoring <- read_csv(VideoScoringFilename, col_types = cols(X10 = col_skip(), X11 = col_skip(), X4 = col_skip(), X5 = col_skip(), X6 = col_skip(), X7 = col_skip(), X8 = col_skip(), X9 = col_skip()))
...
#Add video score
SCPP1DataframeJF220$Score<-AddVideoScoreToSCPP1Data(SCPP1DataframeJF220$InitialisedTime, VideoScoring$InitialisedTime, VideoScoring$Score)
