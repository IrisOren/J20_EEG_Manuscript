...
Filename<-"./Data/Fig4RawTraces/Tmin3088.txt" #From JF220 M1459759032.ndf

Trace<-read.csv(Filename, header = FALSE)
Trace$mV<-Trace$V1*400*10^(-6)
Trace$Time<-seq(from=0,to=((nrow(Trace)-1)/512), by=1/512)
Plot<-ggplot(Trace, aes(x=Time, y=mV))+
  geom_line() +
  scale_y_continuous(limits=c(16.7, 18.05))+
  #geom_text(x=27.5, y=16.7, label="5 s") +
  #geom_text(x=28, y=16.88, label = "0.25 mV")+
...
ggsave("Output/Figures/Fig4/Fig4Ai.pdf", width=12, units="cm", device="pdf")
############
Filename<-"./Data/Fig4RawTraces/Tmin3496.txt" #From JF220 M1459759032.ndf
...
Plot
ggsave("Output/Figures/Fig4/Fig4Aii.pdf", width=12, units="cm", device="pdf")

############
Filename<-"./Data/Fig4RawTraces/Tmin848.txt" #From JF220 M1459762631.ndf
...
Plot<-ggplot(Trace, aes(x=Time, y=mV))+
  geom_line() +
  scale_y_continuous(limits=c(16.7, 18.05))+
  geom_segment(x=0, xend=1, y=16.75, yend=16.75)+ #1s
  geom_segment(x=0, xend=0, y=16.75, yend=17) +  #250microV
  theme_bw()+
  theme(axis.title.x = element_blank(), 
        axis.text.x = element_blank(), 
        axis.ticks.x = element_blank(), 
...
Plot
ggsave("Output/Figures/Fig4/Fig4Aiii.pdf",width=12, units="cm", device="pdf")
```
...
SleepWakeSpikeCountDataWT$SleepWakeColourMod[126]<-"X" #tmin=3248
SleepWakeSpikeCountDataWT$SleepWakeColourMod[156]<-"X" #tmin=3496
...
ggsave("Output/Figures/FigWTECoG/Fig4B.pdf",device="pdf",  width=8, height=10,  units="cm")      


```
```{r Fig4Examples, include=TRUE}
Filename<-"./Data/Fig4RawTraces/J0373/M1470125501_Tmin3476.txt"
...
ggsave("Output/Figures/FigWTECoG/FigWTAi.pdf", width=12, units="cm", device="pdf")
############
Filename<-"./Data/Fig4RawTraces/J0373/M1470136301_Tmin3248.txt"
Trace<-read.csv(Filename, header = FALSE)
Trace$mV<-Trace$V1*400*10^(-6)
Trace$Time<-seq(from=0,to=((nrow(Trace)-1)/512), by=1/512)
Plot<-ggplot(Trace, aes(x=Time, y=mV))+
...
Plot
ggsave("Output/Figures/FigWTECoG/FigWTAii.pdf", width=12, units="cm", device="pdf")

############
Filename<-"./Data/Fig4RawTraces/J0373/M1470136301_Tmin3496.txt" 
...
Plot
ggsave("Output/Figures/FigWTECoG/FigWTAiii.pdf",width=12, units="cm", device="pdf")
```
...
Width=7
FontSize=10
Filename<-"./Data/Fig4RawTraces/J0373/M1470125501_Tmin3476_Spec.txt" 
...
ggsave("Output/Figures/FigWTECoG/FigWTAi_Spec.pdf", device="pdf", height=Height,width=Width, units="cm")

###########

Filename<-"./Data/Fig4RawTraces/J0373/M1470136301_Tmin3248_Spec.txt" 
...
ggsave("Output/Figures/FigWTECoG/FigWTAii_Spec.pdf", device="pdf", height=Height, width=Width, units="cm")

#########
Filename<-"./Data/Fig4RawTraces/J0373/M1470136301_Tmin3496_Spec.txt" 
...
ggsave("Output/Figures/FigWTECog/FigWTAiii_Spec.pdf", device="pdf", height=Height, width=Width, units="cm")
