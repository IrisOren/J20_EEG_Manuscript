...
for(i in 1:nrow(Fig1SummaryDataframe)){
  ...
  Fig1SummaryDataframe$Grtr1SpikeCtrl[i]<-ECDFCurrent$CumFrequency[2]  
}
...
summarise(GroupedData, Q1=quantile (Grtr1SpikeCtrl, probs=0.25, na.rm=TRUE),
          Q2=quantile (Grtr1SpikeCtrl, probs=0.50, na.rm=TRUE),
          Q3=quantile(Grtr1SpikeCtrl, probs=0.75, na.rm=TRUE)                      )
