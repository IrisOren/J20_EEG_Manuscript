...
ThetaOverDelta.aov<-aov(ThetaOverDelta ~ Index + Error(AnimalID/Index), data=ThetaOverDeltaValsLong)
summary(ThetaOverDelta.aov)
qqnorm(residuals(ThetaOverDelta.aov))
