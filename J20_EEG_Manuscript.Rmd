...
FileList_JF220<-c("./Data/VideoScoring/VideoScoringJF220_040416.csv","./Data/VideoScoring/VideoScoringJF220_050416.csv", "./Data/VideoScoring/VideoScoringJF220_060416.csv", "./Data/VideoScoring/VideoScoringJF220_070416.csv", "./Data/VideoScoring/VideoScoringJF220_080416.csv")

DateList_JF220<-c("04/04/2016", "05/04/2016", "06/04/2016", "07/04/2016", "08/04/2016")

SCPP1DataframeJF220VideoTimesAll<-data.frame()
for(fileindex in 1:length(FileList_JF220)){
   # VideoScoringFilename<-"./Data/VideoScoringJF220_040416.csv"
   VideoScoringFilename<-FileList_JF220[[i]] 
  Date<-DateList_JF220[[i]]
    ...
    SCPP1DataframeJF220VideoTimes$SleepWake<-AddVideoScoreToSCPP1Data(SCPP1DataframeJF220VideoTimes$InitialisedTime, VideoScoring$UnixTime, VideoScoring$SleepWake)
    SCPP1DataframeJF220VideoTimesAll<-rbind(SCPP1DataframeJF220VideoTimesAll, SCPP1DataframeJF220VideoTimes)
}
...
SCPP1DataframeJF220VideoTimes$ThetaOverDelta<-SCPP1DataframeJF220VideoTimes$Theta/SCPP1DataframeJF220VideoTimes$Delta
