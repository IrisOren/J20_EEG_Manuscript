...
FileList<-c("./Data/VideoScoring/VideoScoringJF220_040416.csv","./Data/VideoScoring/VideoScoringJF220_050416.csv", "./Data/VideoScoring/VideoScoringJF220_060416.csv", "./Data/VideoScoring/VideoScoringJF220_070416.csv", "./Data/VideoScoring/VideoScoringJF220_080416.csv")#,EXPAND FILELIST  WHEN OTHERS REPLY ABOUT PROCESSED AVAILABLE FILES
           #       "./Data/VideoScoring/VideoScoringJF221_040416.csv","./Data/Vide#oScoring/VideoScoringJF221_050416.csv", #"./Data/VideoScoring/VideoScoringJF221_060416.csv", #"./Data/VideoScoring/VideoScoringJF221_080416.csv")

DateList<-c("04/04/2016", "05/04/2016", "06/04/2016", "07/04/2016", "08/04/2016")#, "04/04/2016", "05/04/2016", "06/04/2016", "08/04/2016")

AnimalIDList<-c("JF220", "JF220", "JF220", "JF220", "JF220")#, "JF221", "JF221", "JF221", "JF221")
...
for(FileIndex in 1:length(FileList)){
   ...
   AnimalIDCurrent<-AnimalIDList[[FileIndex]]
    ...
    if(AnimalIDCurrent=="JF220"){
    SCPP1DataframeVideoTimes<-filter(SCPP1DataframeJF220, InitialisedTime>=VideoStartTime)
    SCPP1DataframeVideoTimes<-filter(SCPP1DataframeVideoTimes, InitialisedTime<=VideoEndTime)
    } else {
      SCPP1DataframeVideoTimes<-filter(SCPP1DataframeJF221, InitialisedTime>=VideoStartTime)
    SCPP1DataframeVideoTimes<-filter(SCPP1DataframeVideoTimes, InitialisedTime<=VideoEndTime)
...
5. Plot theta/delta and sleep wake against time
```{r, PlotThetaDeltaSW, echo=FALSE, include=FALSE}
ListID<-paste("JF220_", "1", sep="")

Theta_1<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=Theta))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])

Delta_1<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=Delta))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])+ylim(0, 300)

ThetaOverDelta_1<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=ThetaOverDelta))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])+ylim(0, 10)

SleepWake_1<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=SleepWake))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])
grid.newpage()
grid.draw(rbind(ggplotGrob(Theta_1), ggplotGrob(Delta_1), ggplotGrob(ThetaOverDelta_1), ggplotGrob(SleepWake_1), size = "last"))
############################
ListID<-paste("JF220_", "2", sep="")

Theta_2<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=Theta))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])

Delta_2<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=Delta))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])+ylim(0, 300)

ThetaOverDelta_2<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=ThetaOverDelta))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])+ylim(0, 10)

SleepWake_2<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=SleepWake))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])
grid.newpage()
grid.draw(rbind(ggplotGrob(Theta_2), ggplotGrob(Delta_2), ggplotGrob(ThetaOverDelta_2), ggplotGrob(SleepWake_2), size = "last"))
#########################

ListID<-paste("JF220_", "3", sep="")

Theta_3<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=Theta))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])

Delta_3<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=Delta))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])+ylim(0, 300)

ThetaOverDelta_3<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=ThetaOverDelta))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])+ylim(0, 10)

SleepWake_3<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=SleepWake))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])
grid.newpage()
grid.draw(rbind(ggplotGrob(Theta_3), ggplotGrob(Delta_3), ggplotGrob(ThetaOverDelta_3), ggplotGrob(SleepWake_3), size = "last"))
#########################

ListID<-paste("JF220_", "4", sep="")

Theta_4<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=Theta))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])

Delta_4<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=Delta))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])+ylim(0, 300)

ThetaOverDelta_4<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=ThetaOverDelta))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])+ylim(0, 10)

SleepWake_4<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=SleepWake))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])
grid.newpage()
grid.draw(rbind(ggplotGrob(Theta_4), ggplotGrob(Delta_4), ggplotGrob(ThetaOverDelta_4), ggplotGrob(SleepWake_4), size = "last"))
#########################

ListID<-paste("JF220_", "5", sep="")

Theta_5<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=Theta))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])

Delta_5<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=Delta))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])+ylim(0, 300)

ThetaOverDelta_5<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=ThetaOverDelta))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])+ylim(0, 10)

SleepWake_5<-ggplot(SCPP1DataframeVideoTimesAllExcluded, aes(x=InitialisedTime, y=SleepWake))+geom_point()+xlim(AnimalIDVideoStartEnd[[ListID]])
grid.newpage()
grid.draw(rbind(ggplotGrob(Theta_5), ggplotGrob(Delta_5), ggplotGrob(ThetaOverDelta_5), ggplotGrob(SleepWake_5), size = "last"))
#########################
```
